...
if ((typeof editNews) === "string") {
    if (newsId) document.querySelector("#main")!.innerHTML = `<h2>404 Not found</h2>`
}
else if (loggedIn && (currentUser.id === editNews.userId)) {
    if (newsId) {
...
else document.querySelector("#main")!.innerHTML = `<h2>401 Unauthorized</h2>`
